...
- **Home** — Landing page with a temperature forecast widget that fetches prediction data from `data/prediction.json`
...
├── js/
│   ├── weather.js          # Temperature forecast widget
│   ├── tank.js             # Fish Tank simulation
│   ├── battle.js           # Tank Battle simulation
│   └── fighter.js          # Fighter Fish simulation
└── data/
    └── prediction.json     # Temperature prediction data (generated by backend)
```
