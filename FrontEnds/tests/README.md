...
| `browser/dungeon-fisher-font-overhaul.spec.js` | Dungeon Fisher font overhaul: Cinzel + Almendra Google Fonts requested and HTTP 200, no JS errors on boot, no horizontal overflow in landscape (900×600) or portrait (393×852), HTML link tags present, screenshots for visual verification of fantasy typography — 14 tests, all pass (runs against localhost:8080 dev server) |
