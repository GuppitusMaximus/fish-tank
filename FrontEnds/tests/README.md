...
| `test-fix-wide-atlas-crop.sh` | Shell script | Wide atlas olive border removal (fix-wide-atlas-crop): valid PNG format ✓, dimensions 256×128 ✓, corner pixels (0,0)/(255,0)/(0,127)/(255,127) not olive ✗, all four edges not predominantly olive ✗, VERSION bumped past 1.10.22 ✓ — 3/5 pass, 2/5 fail; bug filed at Planning/bugs/fix-wide-atlas-crop-olive-border-remains.md |
