...
| `qa-fix-card-camp-background-results.md` | Static QA report for fix-card-camp-background (re-verified 2026-02-22): alpha channel ✓, corners transparent ✓, center opaque ✓, file valid ✓, version bumped 1.10.7→1.10.8 ✓ — **FAIL**: flood fill leaked into scene pixels (52.4% transparent, 306 interior leaks confirmed). Bug open: `Planning/bugs/qa-fix-card-camp-background-flood-fill-leak.md` |
